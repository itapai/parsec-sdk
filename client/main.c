...
int32_t main(int32_t argc, char **argv)
{
	...
	context.window = SDL_CreateWindow("parsec ffe client test", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
	...
	cfg.decoderSoftware = false;
	cfg.decoderCompatibility = true;
	cfg.decoderH265 = true;
